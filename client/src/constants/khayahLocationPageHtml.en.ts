/** Khayah location — map + brand + directions & donation accounts */
...
<div class="khayah-location-page">
  <div class="khayah-location-map-wrap">
    <iframe
      ...
      title="Khayah International office location (Google Maps)"
      src="${MAP_EMBED_SRC}"
      loading="lazy"
  ...
  <div class="khayah-location-body">
    <header class="khayah-location-brand">
      <h2 class="khayah-location-brand__name">Khayah International</h2>
    ...
    <div class="khayah-location-columns">
      <section class="khayah-location-block khayah-location-block--directions" aria-labelledby="khayah-loc-dir-heading">
        <h3 id="khayah-loc-dir-heading" class="khayah-location-block__title">Directions</h3>
