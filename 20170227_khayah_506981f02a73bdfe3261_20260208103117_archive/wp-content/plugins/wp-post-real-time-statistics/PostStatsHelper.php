<?php
    ...
    class PostStatsHelper
    {
        ...
        {
            $ip = PostStatsHelper::get_visitor_ip ();
        ...
        public static function show_visits_column ($post_ID)
        {
            ...
            try {
                ...
                <a href="#id_views<?php echo $post_ID; ?>" class="cn_popup-views" name="<?php echo $post_ID; ?>">
                    <?php echo intval ($visits_total); ?>
                    <span class="dashicons dashicons-chart-bar"></span>
                </a>

                <div id="id_views<?php echo $post_ID; ?>" class="poststats_modal_block"
                    ...
                    <div class="popup_block_center">
                        ...
                        <div class="poststats_tab">
                            <div id="tab-1" class="poststats_tab-content">
                                <h2 class="title_vs"><?php echo $POST_TITLE; ?></h2>
								<br/>
								<center>
                                ...
                                <table class="table_stat">
                                    <tr>
                                        ...
                                        <td class="td-counts"><?php echo $visits_today; ?></td>
                                        <td class="td-style-cell">This Month</td>
                                        <td class="td-counts"><?php echo $visits_month; ?></td>
                                    </tr>
                                    <tr>
                                        <td class="td-style-cell">Yesterday</td>
                                        <td class="td-counts"><?php echo $visits_yesterday; ?></td>
                                        <td class="td-style-cell">This Year</td>
                                        <td class="td-counts"><?php echo $visits_year; ?></td>
                                    </tr>
                                    <tr>
                                        <td class="td-style-cell">This Week</td>
                                        <td class="td-counts"><?php echo $visits_week; ?></td>
                                        <td class="td-style-cell">Total</td>
                                        <td class="td-counts"><?php echo $visits_total; ?></td>
                                    </tr>
                                </table>
                                ...
                                <div style="text-align:center;">
                                    ...
                                    <input type="text"
                                           id="poststats_tab_1_from_<?php echo $post_ID; ?>"
                                           name="fr_graph<?php echo $post_ID; ?>"
                                           value="<?php echo $CHART_VISITS_DEFAULT_START ?>"/>
                                    ...
                                    <input type="text"
                                           id="poststats_tab_1_to_<?php echo $post_ID; ?>"
                                           name="tg_graph<?php echo $post_ID; ?>"
                                           value="<?php echo $CHART_VISITS_DEFAULT_END ?>"/>
                                </div>

                                <br>

                                <div class="wrapchart_1_<?php echo $post_ID; ?>">Loading...</div>
                            ...
                            <div id="tab-2" class="poststats_tab-content">
                                ...
                                <div style="text-align:center;">
                                    <label for="from">From</label>&nbsp;
                                    <input type="text"
                                           id="poststats_tab_2_from_<?php echo $post_ID; ?>"
                                           name="from<?php echo $post_ID; ?>"
                                           value="<?php echo $CHART_VISITS_DEFAULT_START ?>"/>
                                    ...
                                    <label for="to">To </label>&nbsp;
                                    <input type="text"
                                           id="poststats_tab_2_to_<?php echo $post_ID; ?>"
                                           name="to<?php echo $post_ID; ?>"
                                           value="<?php echo $CHART_VISITS_DEFAULT_END ?>"/>
                                </div>
                                ...
                                <div class="wrapchart_2_<?php echo $post_ID; ?>">Loading...</div>
