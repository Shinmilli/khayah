...
function normalizeStoredMediaUrl(value) {
    ...
    if ((0, cloudinary_2.isCloudinaryConfigured)()) {
        (0, cloudinary_2.configureCloudinary)();
        const resourceType = /\/documents\//.test(s) ? 'raw' : 'image';
        try {
            return cloudinary_1.v2.url(s, { resource_type: resourceType, secure: true });
        }
        catch {
            return s;
        }
...
//# sourceMappingURL=normalizeStoredMediaUrl.js.map